...
const Home = () => {
    ...
    return (
      <div className="flex flex-1 bg-white">
        <div className="home-container bg-white">
          <p className="body-medium text-red-500">Something bad happened</p>
        </div>
        <div className="home-creators bg-white">
          <p className="body-medium text-red-500">Something bad happened</p>
        </div>
      </div>
    );
  ...
  return (
    <div className="flex flex-1 p-6 gap-6">
      ...
      <div className="home-creators p-4 rounded-lg shadow">
        <h3 className="h3-bold mb-4">Top Creators</h3>
